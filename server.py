...
from todays_boxscore import (
    today_games_dict,
    endpoint,
    boxscore_dict,
    d_with_abbreviations,
)
...
json_file_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "player_stats.json")
)
...
def get_top_ten_players(season, category):
    ...
    league_leaders = LeagueLeaders(
        season=season, per_mode48="PerGame", stat_category_abbreviation=category
    )
